...
```
Add-NbxDCIMFrontPort [-Device] <UInt64> [[-Module] <UInt64>] [-Name] <String> [[-Label] <String>]
 [-Type] <String> [[-Color] <String>] [-Rear_Port] <UInt64> [[-Rear_Port_Position] <UInt64>]
 [[-Description] <String>] [[-Mark_Connected] <Boolean>] [[-Tags] <UInt16[]>]
